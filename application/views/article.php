														...
														<div class="row">
																<div class="col-md-3 no-padding photobox">
																		<div class="add-image"><span class="photo-count"><i class="fa fa-camera"></i> <?php echo $jml_foto; ?> </span>
																			<a href="<?php echo $link_kat; ?>"><img class="thumbnail no-margin" src="images/app/thumb/<?php echo $baris->gambar; ?>" title="<?php echo ucwords($baris->judul); ?>" alt="<?php echo ucwords($baris->judul); ?>" width="50" height="200"></a>
																		</div>
																</div>
														<!--/.photobox-->
