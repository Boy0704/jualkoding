													...
													<div class="block">
															...
															<div class="data-fluid">
																	<table id="tablex" class="table fpTable lcnp display" cellpadding="0" cellspacing="0" width="100%">
																			...
																			<?php 
																			$no=1;
																				$sql=$this->db->query("SELECT * FROM tbl_app");
																				foreach ($sql->result() as $key => $value) {
																					?>
<tr>
																					<td><?php echo $no++ ?></td>
																					<td><a href="d/<?php echo $value->url ?>"><?php echo $value->nama_app ?></a></td>
																					<td style="text-align:center">
																							<a class="btn btn-primary" href="d/<?php echo $value->url ?>">Pesan</a>
																					</td>
																				</tr>
																					<?php
																				}
