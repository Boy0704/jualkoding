				...
				<div class="container">
						...
						<div class="page-header">
								<div class="wrap-title">
										...
										<h1>Registrasi <small><a href="<?php echo base_url(); ?>">Home</a> / Registrasi</small></h1>
								</div>
								<!--
								<ul class="breadcrumb">
																	...
																	<br>
																		<form method="post" action="" class="form-horizontal" role="form">
																		  <div class="form-group">
																		    ...
																		    <div class="col-sm-10">
																		      <input type="text" name="username" class="form-control" onkeyup="cek_spasi();" id="username" placeholder="Username" required>
																		    </div>
																		  </div>
																			<div class="form-group">
																		  ...
																		  <div class="form-group">
																		    <div class="col-sm-offset-2 col-sm-10">
																					<a href="login">Sign In disini</a> |
																					<a href="lp">Reset Password</a>
																		      <button type="submit" name="reg" class="btn btn-default" style="float:right;">Registrasi</button>
																		    </div>
																		  </div>
																		</form>
															  </div>
